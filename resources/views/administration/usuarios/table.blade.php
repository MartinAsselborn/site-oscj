...
<div class="text-right">  <a title="Ver" href="/createUser" class="btn btn-outline btn-success">
...
<table id="table" class="table table-dark" style="border-radius:20px 0 20px 20px;">
  ...
  @foreach($datos as $dato)
    <tr>
      ...
      <td>{{$dato->email}}</td>
      <td>
                    <a title="Ver" href="/usuario/{{$dato->id}}" class="btn btn-outline btn-primary">
                         <i class="fa fa-eye fa-1x"></i>
                    </a>
                    <a href="/editUser/{{$dato->id}}" class="btn btn-outline btn-primary">
